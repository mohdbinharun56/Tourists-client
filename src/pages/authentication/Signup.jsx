                ...
                <div className="p-5 border-r border-t border-b border-white w-full">
                    <form onSubmit={handleRegister} className="w-full">
                        ...
                        <div className="md:flex gap-10">
                            <input type="submit" name="register" value="Register" className="btn w-1/2 btn-accent border border-black p-2 text-md mb-5" placeholder="Enter your password"></input>
                            <Link to={'/login'} className="w-1/2"><input type="submit" name="login" value="Login" className="btn w-full btn-active border border-black p-2 text-md mb-5" placeholder="Enter your password"></input></Link>
                        </div>
